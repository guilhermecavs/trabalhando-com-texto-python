...
\begin{itemize}[leftmargin=1.3em,itemsep=2pt,topsep=3pt]
  \item \textbf{@tok2vec@} mapeia os tokens para suas representações numéricas (veremos na Parte III).
  \item \textbf{@attribute_ruler@} aplica regras definidas pelo usuário aos tokens e adiciona essa informação como atributo, se solicitado.
\end{itemize}
...
\subsection{Analisando o pipeline com \textnormal{@analyze_pipes()@}}
